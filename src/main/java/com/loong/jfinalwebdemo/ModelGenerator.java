...
public class ModelGenerator {
	...
	public static void main(String[] args) {
		...
		// base model 所使用的包名
		String baseModelPackageName = "com.loong.jfinalwebdemo.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com/loong/jfinalwebdemo/model/base";
		System.out.println(baseModelOutputDir);
		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.loong.jfinalwebdemo.model";
